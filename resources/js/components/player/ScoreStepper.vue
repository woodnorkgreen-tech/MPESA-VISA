  ...
  <div class="min-w-0 text-center">
    ...
    <div class="overflow-hidden rounded-2xl border border-white/10 bg-black/20">
      <button type="button" @click="change(1)" :aria-label="`Increase ${team} score`"
        class="flex min-h-12 w-full items-center justify-center border-b border-white/10 text-2xl font-black text-safaricom-light transition hover:bg-white/5 active:bg-safaricom/20">+</button>
