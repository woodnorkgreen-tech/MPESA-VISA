<template>
  <div class="w-full rounded-2xl border border-white/10 bg-black/25 px-4 py-3 lg:px-6">
    <div class="mb-2 flex items-center justify-between">
      <p class="text-[clamp(.6rem,1vw,1rem)] font-black uppercase tracking-[.18em] text-safaricom-light">
        <span class="mr-1 inline-block h-2 w-2 animate-pulse rounded-full bg-safaricom-light"></span> Live leaderboard
      </p>
